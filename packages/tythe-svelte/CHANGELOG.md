# Changelog · `@tythe/svelte`

All notable changes to the `@tythe/svelte` npm package will be documented in
...
## [0.1.1](https://github.com/tamimbinhakim/tythe/compare/tythe-svelte-v0.1.0...tythe-svelte-v0.1.1) (2026-05-13)
...
- Initial scaffold: `createTytheStores(api)` factory returning
