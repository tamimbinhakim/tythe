# Changelog · `@tythe/solid`

All notable changes to the `@tythe/solid` npm package will be documented in
...
## [0.1.1](https://github.com/tamimbinhakim/tythe/compare/tythe-solid-v0.1.0...tythe-solid-v0.1.1) (2026-05-13)
...
- Initial scaffold: `createTytheResources(api)` factory returning
