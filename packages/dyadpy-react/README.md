...
import { createDyadpyHooks } from "@dyadpy/react";
import { api } from "./client"; // generated by `dyadpy dev`

export const { useQuery, useMutation, useSubscription } =
  createDyadpyHooks(api);
```
...
- `@dyadpy/ts` (workspace; required by your generated `client.ts`)
