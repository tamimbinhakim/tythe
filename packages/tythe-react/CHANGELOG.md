# Changelog · `@tythe/react`

All notable changes to the `@tythe/react` npm package will be documented in
...
- Initial scaffold: `createTytheHooks(api)` factory returning
  `useQuery`, `useMutation`, and `useSubscription` hooks for
  Tythe-generated clients. Built on TanStack Query v5; the hook types
